...
function InnovaEditor(oName)
    ...
    this.preserveSpace=false;//not used in moz
    this.css="";
...
function RENDER(sPreloadHTML)
            ...
            case "Clean":
                if(this.btnClean)
                    ...
                    sHTMLDropMenus+="<table id=dropClean"+this.oName+" cellpadding=0 cellspacing=0 "+
                        "style='z-index:1;display:none;position:absolute;border:#80788D 1px solid;"+
                        "cursor:default;background-color:#fbfbfd;' unselectable=on>"+
						"<tr><td onclick=\"document.getElementById('dropClean"+this.oName+"').style.display='none';if("+this.oName+".replaceAllFontsWithSpan())alert(getText('All FONTs removed.'));else alert(getText('No FONTs.'));\" "+
                            "style=\"padding:2px;padding-top:1px;font-family:Tahoma;font-size:11px;color:black;\" "+
                            "onmouseover=\"this.style.backgroundColor='#708090';this.style.color='#FFFFFF';\" "+
                            "onmouseout=\"this.style.backgroundColor='';this.style.color='#000000';\" unselectable=on>"+getText("Remove Font Tags")+"</td></tr>"+
						"<tr><td onclick=\"document.getElementById('dropClean"+this.oName+"').style.display='none';if("+this.oName+".removeUnusedSpan())alert(getText('All unused SPANs removed.'));else alert(getText('No unused SPANs.'));\" "+
                            "style=\"padding:2px;padding-top:1px;font-family:Tahoma;font-size:11px;color:black;\" "+
                            "onmouseover=\"this.style.backgroundColor='#708090';this.style.color='#FFFFFF';\" "+
    ...
    sHTML+="<table id=idArea"+this.oName+" name=idArea"+this.oName+" border='0px' "+
            ...
            "<table cellpadding=0 cellspacing=0 border=0><tr><td dir=ltr style='padding:0px;'>"+
            sHTMLIcons+
            "</td></tr></table>"+
            "</td></tr>"+
...
function openStyleSelect()
	...
	sHTML+="<div unselectable=on style='overflow:auto;width:200px;height:"+h+"px;'><table cellpadding=0 cellspacing=0 style='background:#fcfcfc;height:100%;width:100%'>";
	for(var i=0;i<arrStyle.length;i++)
		{
...
function fullScreen()
    ...
    if(this.stateFullScreen)
        ...
        if(this.width.indexOf("%")!=-1)edtArea.style.width=this.width;
        else edtArea.style.width=parseInt(this.width)+"px";

		if(this.height.indexOf("%")!=-1)edtArea.style.height=this.height;
...
function hide()
	...
	if(this.btnClean)document.getElementById("dropClean"+this.oName).style.display="none";
...
function writeIconToggle(id,command,img,title)
    ...
    sHTML=""+
        ...
        "<span style='position:relative'><span unselectable='on' style='position:absolute;clip: rect(0px "+w+"px "+h+"px 0px)'>"+
...
function writeDropDown(id,command,img,title,width)
    ...
    sHTML=""+
        ...
        "<span style='position:relative'><span style='position:absolute;clip: rect(0px "+w+"px "+h+"px 0px)'>"+
